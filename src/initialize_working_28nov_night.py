...
for i in range(30):
    ...
    topicCount.append(topics)
    perplexityTrain.append(p_train)
    perplexityTest.append(p_test)
...
#
#print "Topics \t p_train \t p_test"
#for i in range(30):
#    print topicCount[i], perplexityTrain[i], perplexityTest[i]
